...
try:
    ...
    from nfelib.v4_00.retEnvConfRecebto import (
        TEnvEvento as TEnvEventoManifestacao,  # noga
    )
    from nfelib.v4_00.retEnvConfRecebto import TEvento as TEventoManifestacao  # noga
    from nfelib.v4_00.retEnvConfRecebto import (
        descEventoType as descEventoManifestacao,  # noga
    )
    from nfelib.v4_00.retEnvConfRecebto import (
        detEventoType as detEventoManifestacao,  # noga
    )
    from nfelib.v4_00.retEnvConfRecebto import (
        infEventoType as infEventoManifestacao,  # noga
    )
    from nfelib.v4_00.retEnvConfRecebto import (
        tpEventoType as eventoManifestacao,  # noga
    )
except ImportError:
    pass
